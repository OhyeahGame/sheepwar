...
//		"/main_select_left_base.png",           //remove on 11-7 for dow's requirement  
	...
	public static String gameInfo[] = {   
		...
		"【道具说明】#r时光闹钟：时间静止10秒#r捕狼网：发射一张大网网住灰太狼#r防狼套装：使用后抵抗子弹的攻击#r驱狼光波:发出一道十万伏特的电流，电晕碰到的灰太狼#r替身玩偶：增加一条命#r驱狼竖琴：使用后清除所有的梯子或者正在推南瓜的灰太狼#r连发:使用后连续发射四颗子弹，单关有效#r强力磁石：击落所有空中的灰太狼",
		
		"【游戏简介】#r喜羊羊大战灰太狼是一款闯关类游戏，#r总共有15关。玩家控制喜羊羊击落一定数量的灰太狼即可过关#r此外玩家还可以在道具商城内购买各种道具来获得更有趣的体验#r除了闯关外，游戏中还推出了成就系统和排行榜，#r增加了玩家在游戏过程中的动力和目标",
		"",
	};
	
	/*商城商品介绍*/   
	public static String propIntroduce [][]= {
		{"时光闹钟:#r时间静止10秒#r价格：20游戏币","驱狼竖琴:#r使用后清除所有梯子上或者正在推南瓜的灰太狼#r价格：30游戏币"},//shopY
		{"捕狼网:#r发射一张大网网住灰太狼#r价格：20游戏币","连发:#r使用后连续发射四颗飞镖，单关有效#r价格：30游戏币"},
		{"防狼套装:#r开启后得到30秒的无敌效#r果，抵御各种攻击#r价格：30游戏币","强力磁石:#r击落所有空中的灰太狼#r价格：50游戏币"},
