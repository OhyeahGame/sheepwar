...
//		"/main_select_left_base.png",           //remove on 11-7 for dow's requirement  
	...
	public static String gameInfo[] = {   
		...
		"【道具说明】#r光闹钟：时间静止10秒。#r捕狼网：发射出的子弹碰到灰太狼就会张开一张网，大网内的灰太狼都会掉落。#r防狼套装：开启后有5秒的无敌效果，抵御各种攻击。#r驱狼光波:发出一道十万伏特的电流，电晕碰到的灰太狼,持续5秒。#r替身玩偶：增加一条命。#r驱狼竖琴：使用后清除所有的梯子或者正在推石头的灰太狼。#r连发:使用后连续发射四颗子弹，单关有效。#r强力磁石：击落所有空中的灰太狼。",
